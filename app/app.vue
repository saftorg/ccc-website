...
<template>
  <div class="text-white border-white font-manrope">
    <!-- Background video -->
    <div
      class="w-full h-screen flex flex-col items-center justify-center brightness-50 -z-10 fixed inset-0 overflow-hidden"
    >
      <video
    ...
    <div class="md:hidden min-h-screen flex flex-col">
      ...
      >
        ...
        />
        <a
          class="rounded-full text-sm bg-white px-4 py-2 text-black whitespace-nowrap"
    ...
    <!-- DESKTOP LAYOUT (viewport-locked) -->
    <div class="hidden md:flex h-screen flex-col overflow-hidden">
      ...
      <main
        class="flex-1 min-h-0 grid grid-cols-[1.2fr,2fr] grid-rows-[2fr,3fr]"
      >
